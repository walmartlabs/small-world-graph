...
class SixtyFourRelationshipHolderImpl : public RelationshipHolder {
  public:
    ...
    CloseSiteVector sites_close_to(const int site_id);
...
vector<Relationship> 
SixtyFourRelationshipHolderImpl::distances(const vector<int>& ids)
{
...
CloseSiteVector
SixtyFourRelationshipHolderImpl::sites_close_to(const int site_id)
{
